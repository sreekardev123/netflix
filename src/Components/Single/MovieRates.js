...
// import UserMovies from "../../assets/Data/UserData";
        ...
        <div className="mt-10 xl:grid flex-colo grid-cols-5 gap-12 bg-dry xs:p-10 py-10 px-2 sm:p-10 rounded">
          ...
          <div className="xl:col-span-2 w-full flex flex-col gap-8">
            ...
            <p className="text-sm leading-7 font-medium text-border">
              ...
              page.Lorem ipsum dolor sit amet,consectetur adipiscing elit.Donec
            </p>
          ...
          <div className="col-span-3  flex flex-col gap-6">
            ...
            <div className="w-full flex flex-col bg-main gap-6 rounded-lg md:p-12 p-6 h-header   overflow-y-scroll custom-scrollbar ">
              {
                UserData.map((user,i)=>(
