...
function Filters({ setSelectedCategory }) { // Receive the setSelectedCategory function as a prop
  ...
  const Filter = [
    {
      ...
      onchange: (category) => {
        ...
        setSelectedCategory(category.title); // Update the selected category
      },
