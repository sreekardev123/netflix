    ...
    {/* users */}
      {users ? (
        <>
          ...
          <button className="bg-subMain text-white rounded flex-colo w-6 h-6 ml-12 mt-6">
            <MdDelete />
          </button>
        </>
      ) 
...
function Table2({ data, users, OnEditFunction }) {
  return (
    <div className="overflow-x-scroll overflow-hidden relative w-full no-scrollbar">
